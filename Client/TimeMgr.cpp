...
void CTimeMgr::Initialize()
{
	...
	QueryPerformanceFrequency(&m_CpuTick);	// 10000
		
}

void CTimeMgr::Update()
{
	QueryPerformanceCounter(&m_CurTime);	// 1300
	
	if (m_CurTime.QuadPart - m_OriginTime.QuadPart > m_CpuTick.QuadPart)	//1000,0000
	{
